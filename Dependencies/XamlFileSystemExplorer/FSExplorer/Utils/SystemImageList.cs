...
namespace XamlFSExplorer.Utils
{
    ...
    public class SystemImageList : IDisposable
    {
        ...
        public static IntPtr Test()
        {
            ...
            int shfiSize = (int)Marshal.SizeOf(shfi.GetType());
        ...
        [DllImport("shell32.dll")]
        private static extern IntPtr SHGetFileInfo(IntPtr pszPath, int dwFileAttributes,
            ref SHFILEINFO psfi, int cbSizeFileInfo, int uFlags);
        ...
        public SystemImageList(IconSize size)
        {
            ...
            _size = size; //There is no thumbnail mode in shell.
        ...
        {
            SHGetFileInfoConstants dwFlags; int dwAttr;
            ...
            SHFILEINFO shfi = new SHFILEINFO();
            int shfiSize = (int)Marshal.SizeOf(shfi.GetType());
            IntPtr retVal = SHGetFileInfo(fileName, dwAttr, ref shfi, shfiSize, ((int)(dwFlags) | (int)iconState));
        ...
        private int getIconIndex(IntPtr pidlPtr, bool isDirectory, bool forceLoadFromDisk, ShellIconStateConstants iconState)
        {
            ...
            SHFILEINFO shfi = new SHFILEINFO();
            int shfiSize = (int)Marshal.SizeOf(shfi.GetType());
            IntPtr retVal = SHGetFileInfo(pidlPtr, dwAttr, ref shfi, shfiSize, ((int)(dwFlags) | (int)iconState));
